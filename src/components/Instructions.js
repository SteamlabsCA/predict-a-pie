		...
		return (
			<div className='Instructions'>
				<div className='Instructions-container'>
					...
					<p>
						Qu'est-ce qui fait qu'un pâté est plus savoureux qu'un autre? Et si vous aviez tous les ingrédients du monde pour créer la tarte parfaite?
						Dans cet atelier, vous allez créer un réseau neuronal pour y parvenir! Vous utiliserez ensuite vos nouvelles connaissances pour tester un
						plus grand réseau neuronal qui a été créé à partir de l'apprentissage automatique dans le but d'analyser des milliers de recettes et
					...
					<p>
						Cette application web se divise principalement en deux sections : "Construire un réseau neuronal" et "Tester un modèle pré-entraîné". Vous
						pouvez y accéder à tout moment à partir du menu situé dans le coin supérieur gauche.
					</p>
					<h2>Construire un réseau neuronal (RN)</h2>
					<p>
						Dans cette activité, vous pouvez construire un réseau neuronal réel et fonctionnel. Les{' '}
						<Definition text={strings.neuronDef}>neurones</Definition> de la première couche (celle de gauche) sont vos "entrées". Considérez-les
						comme les ingrédients, ou les éléments d'information sur lesquels votre RN fondera ses décisions. La dernière couche (à droite) de{' '}
						<Definition text={strings.neuronDef}>neurones</Definition> représente les décisions, ou "classifications", que le réseau neuronal peut
						prendre sur la base de ces entrées. Ajoutez les <Definition text={strings.neuronDef}>neurones</Definition> un par un, connectez-les entre
						eux pour indiquer quelles entrées mènent à quelles décisions de sortie. Si vous devez détecter des combinaisons d'entrées, vous pouvez
						ajouter des "couches cachées" au milieu pour détecter ces combinaisons. Si nécessaire, vous pouvez cliquer sur le symbole (+) ou (-) de
					...
					<p>
						Cette activité peut être réalisée seul ou en groupe. Pour un groupe, commencez par "Créer une salle de classe", et demandez à chacun
						d'aller sur l'URL générée.
					</p>
					<p>
						Le réseau neuronal de cette activité a été entraîné sur des milliers de recettes pour être capable de classifier n'importe quelle
						combinaison d'ingrédients comme étant une tarte "Sucrée", une "Quiche", une "Pizza", un "Pâté" ou quelque chose d'"Autre". Il peut
						maintenant généraliser et classifier n'importe quelle combinaison d'ingrédients disponibles.
					</p>
					<p>
						Essayez différentes combinaisons d'ingrédients et voyez ce que le réseau neuronal en pense ! Vous pouvez également cliquer sur le bouton
						"Trouver une recette" pour générer une nouvelle recette.
					</p>
					<p>Sauvegardez les recettes que vous aimez pour pouvoir les consulter ultérieurement.</p>
					<p>
						Vous pouvez signaler les classifications avec lesquelles vous n'êtes pas en accord et sélectionnez la classification correcte. Sur la page
					...
					<p>
						<a
							onClick={() =>
								gtmTrack('out_btn_click', 'Instructions', 'Out Bound: https://www.amazonfutureengineer.com/', 'https://www.amazonfutureengineer.com/')
							}
					...
					<ul>
						<p>
							<li>
								Attribution - Vous devez donner le crédit approprié, fournir un lien vers la licence et indiquer si des modifications ont été
								apportées. Vous pouvez le faire de toute manière raisonnable, mais pas d'une manière qui suggère que le donneur de licence vous
								approuve ou approuve votre utilisation.
							</li>
							<li>
								ShareAlike - Si vous remixez, transformez ou développez le matériel, vous devez distribuer vos contributions sous la même licence que
								l'original.
							</li>
						</p>
					</ul>
		...
		return (
			<div className='Instructions'>
				<div className='Instructions-container'>
					...
					<p>
						In this activity, you can build a real, working Neural Network. The <Definition text={strings.neuronDef}>neuron</Definition> nodes in the
						first layer on the left are your “inputs”. Think of these as the ingredients, or pieces of information that your NN will base its
						decisions on. The last layer of <Definition text={strings.neuronDef}>neurons</Definition> are the decisions, or “classifications” that the
						neural network can make based on these inputs. Add <Definition text={strings.neuronDef}>neurons</Definition> one at a time, connect them
						together to indicate what inputs lead to what output decisions. If you need to detect combinations of inputs, you can add “hidden layers”
					...
					<p>
						The Neural Network in this activity has been trained on thousands of recipes to be able to classify any recipe as “Sweet Pie”, “Quiche”,
						“Savoury Pie” and “Disgusting” from a combination of the input ingredients. Now it can generalize and classify any of the millions of
						combinations of recipes.
					</p>
					<p>
						Try different combinations of ingredients and see what the Neural Network thinks of them! You can also click on the “Find Recipe” button
