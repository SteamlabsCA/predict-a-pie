...
function Instructions() {
  ...
  if (strings.getLanguage() == 'fr') {
    ...
    <p>
    Vous pouvez en savoir plus à propos de cette activité et trouver des liens vers <a href="https://steamlabs.ca/ai-programs/predict-a-pie" target="_new">des présentations éducatives sur l'IA</a> sur le site web de Steamlabs.
    
    </p>
    <p>
    Cette application web se divise principalement en deux sections : "Construire un réseau neuronal" et "Tester un modèle pré-entraîné". Vous pouvez y accéder à tout moment à partir du menu situé dans le coin supérieur gauche.
...
Si nécessaire, vous pouvez cliquer sur le symbole (+) ou (-) de n'importe quel nœud et modifier les "poids" pour indiquer l'importance relative de chaque nœud entrant.
    ...
    <p>
    Sauvegardez les recettes que vous aimez pour pouvoir les consulter ultérieurement.
    </p>
    <p>
    Vous pouvez signaler les classifications avec lesquelles vous n'êtes pas en accord et sélectionnez la classification correcte. Sur la page "Voir les statistiques de la classe", vous pouvez voir les classifications d'autres participants et vérifier s'ils sont d'accord avec vous.
    </p>
    ...
    <h2>Crédits</h2>
    <p>
      <a href="https://www.steamlabs.ca/" target="_new"><img src="https://steamlabs.ca/wp-content/uploads/2020/04/SteamLabs_Wordmark_RGB_Blue.jpg" width="150" border="0" align="left" /></a> "Predict-a-Pie" est une création de <a href="https://www.steamlabs.ca/" target="_new">Steamlabs</a>.
      <br clear="left" />
    </p>
    <p>
      <a href="https://kidscodejeunesse.org/" target="_new"><img src="https://steamlabs.ca/wp-content/uploads/2021/01/300px-KCJ.png" width="150" border="0" align="left" /></a> Co-conçu par <a href="https://www.steamlabs.ca/" target="_new">Steamlabs</a> et <a href="https://kidscodejeunesse.org/" target="_new">Kids Code Jeunesse</a>.
      <br clear="left" />
    </p>
    <p>
      <a href="https://www.amazonfutureengineer.com/" target="_new"><img src="https://steamlabs.ca/wp-content/uploads/2021/04/Amazon-Future-Engineer-Logo.png" width="150" border="0" align="left" /></a> Créé grâce au financement de <a href="https://www.amazonfutureengineer.com/" target="_new">Amazon Future Engineer</a>.
      <br clear="left" />
    </p>
    ...
    <p>
    Sous licence Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)
</p>
    <p>
...
<ul>
<li>Attribution - Vous devez donner le crédit approprié, fournir un lien vers la licence et indiquer si des modifications ont été apportées. Vous pouvez le faire de toute manière raisonnable, mais pas d'une manière qui suggère que le donneur de licence vous approuve ou approuve votre utilisation.</li>
<li>ShareAlike - Si vous remixez, transformez ou développez le matériel, vous devez distribuer vos contributions sous la même licence que l'original.</li>
    ...
    <p>
    Les détails complets de cette licence peuvent être trouvés ici : <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_new">https://creativecommons.org/licenses/by-sa/4.0/</a>
</p>
